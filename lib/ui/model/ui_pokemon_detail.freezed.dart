...
part of 'ui_pokemon_detail.dart';
...
/// @nodoc
abstract class $UiPokemonDetailCopyWith<$Res> {
  factory $UiPokemonDetailCopyWith(
          UiPokemonDetail value, $Res Function(UiPokemonDetail) then) =
...
/// @nodoc
class _$UiPokemonDetailCopyWithImpl<$Res, $Val extends UiPokemonDetail>
    implements $UiPokemonDetailCopyWith<$Res> {
  _$UiPokemonDetailCopyWithImpl(this._value, this._then);
...
class _$_UiPokemonDetail implements _UiPokemonDetail {
  ...
  @override
  String toString() {
    return 'UiPokemonDetail(id: $id, name: $name, form: $form, flavorText: $flavorText, types: $types, weight: $weight, height: $height, stats: $stats, chains: $chains, varietyIds: $varietyIds)';
  }
